 ...
 * @author FRED
 */
public class GradingSystemReview extends JFrame implements ActionListener {
    ...
    private FredButton view = new FredButton("Apply");
    ...
    public GradingSystemReview() {
        setSize(width, height);
        setTitle("Entered Marks Grading System/Exam Weight/Teacher Intials Review");
                                ...
                                new Thread() {
                                    ...
                                    public void run() {
                                        ...
                                        try {
                                            ...
                                            String sq1 = "Select * from markstable where academicyear='" + jacademicyear.getSelectedItem() + "' and examcode='" + excode + "' group by subjectcode,admnumber";
...
//    weight = 100;
//}
                                            String sq = "Select * from markstable where academicyear='" + jacademicyear.getSelectedItem() + "' and examcode='" + excode + "' group by subjectcode,admnumber";
                                            ...
                                            while (rx.next()) {
                                                ...
                                                String qrry = "Update markstable set examgrade='" + grade + "' ,class_teacher_initials='" + teacherintial + "',exampoints='" + point + "' ,convertedscore='" + converted + "',convertedscoreoutof='" + weight + "' where academicyear='" + jacademicyear.getSelectedItem() + "' and examcode='" + excode + "' and subjectcode='" + subcode + "' and admnumber='" + adm + "'";
