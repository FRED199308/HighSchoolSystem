 ...
 * @author FRED
 */
public class LostBooks implements ActionListener {
    ...
    public JPanel LostBooksPanel() {
        holder = new JPanel();
        top = new JPanel();
        bottom = new JPanel();
        booktypefilter = new FredCombo("Filter Book By Type");
        infor = new FredLabel("Lost Books");
        ...
        top.add(infor, "growx,pushx,gapleft 50");
        ...
        try {
            ...
            if (Globals.Level.equalsIgnoreCase("Admin")) {
                ...
                int counter = 1;
                String sql3 = "Select books.bookserial,bookname,subjectcode,classcode,admnumber,dateissued,booktitle from issuedbooks,books where books.bookserial=issuedbooks.bookserial and books.status='" + "ISSUED" + "'  and issuedbooks.status='" + "LOST" + "' order by bookname";
                ps = con.prepareStatement(sql3);
                rs = ps.executeQuery();
                while (rs.next()) {
            ...
            if (Globals.Level.equalsIgnoreCase("Admin")) {
                ...
                try {
                    if (subjectfilter.getSelectedIndex() > 0 && classfilter.getSelectedIndex() == 0) {
                        infor.setText(subjectfilter.getSelectedItem() + " LOST BOOKS");
                        int counter = 1;
                        String sql3 = "Select books.bookserial,bookname,admnumber,dateissued,booktitle from issuedbooks,books where books.bookserial=issuedbooks.bookserial and books.status='" + "ISSUED" + "' and issuedbooks.status='" + "LOST" + "' order by bookname";
                        ps = con.prepareStatement(sql3);
                        rs = ps.executeQuery();
                        ...
                        infor.setText(classfilter.getSelectedItem() + "  " + subjectfilter.getSelectedItem() + " LOST BOOKS");
                        int counter = 1;
                        String sql3 = "Select books.bookserial,bookname,admnumber,dateissued,booktitle from issuedbooks,books where books.bookserial=issuedbooks.bookserial and books.status='" + "ISSUED" + "' and issuedbooks.status='" + "LOST" + "'  order by bookname";
                        ps = con.prepareStatement(sql3);
                        rs = ps.executeQuery();
                ...
                if (subjectfilter.getSelectedIndex() > 0 && classfilter.getSelectedIndex() == 0) {
                    ...
                    try {
                        infor.setText(subjectfilter.getSelectedItem() + " LOST BOOKS (Limited View)");
                        int counter = 1;
                        String sql3 = "Select books.bookserial,bookname,subjectcode,classcode,admnumber,dateissued,booktitle from issuedbooks,books where books.bookserial=issuedbooks.bookserial and books.status='" + "ISSUED" + "'  and issuedbooks.status!='" + "LOST" + "'  order by bookname";
                        ps = con.prepareStatement(sql3);
                        rs = ps.executeQuery();
                    ...
                    infor.setText(classfilter.getSelectedItem() + "  " + subjectfilter.getSelectedItem() + " LOST BOOKS (Limited View)");
                    try {
                        int counter = 1;
                        String sql3 = "Select books.bookserial,bookname,subjectcode,classcode,admnumber,dateissued,booktitle from issuedbooks,books where books.bookserial=issuedbooks.bookserial and books.status='" + "ISSUED" + "'  and issuedbooks.status='" + "LOST" + "' order by bookname";
                        ps = con.prepareStatement(sql3);
            ...
            if (Globals.Level.equalsIgnoreCase("Admin")) {
                ...
                try {
                    if (classfilter.getSelectedIndex() == 0) {
                        infor.setText("LOST Books".toUpperCase());
                        int counter = 1;
                        String sql3 = "Select books.bookserial,bookname,admnumber,dateissued,booktitle from issuedbooks,books where books.bookserial=issuedbooks.bookserial and books.status='" + "ISSUED" + "' and issuedbooks.status='" + "LOST" + "' order by bookname";
                        ps = con.prepareStatement(sql3);
                        rs = ps.executeQuery();
                        ...
                        infor.setText(classfilter.getSelectedItem() + " LOST BOOKS");
                        int counter = 1;
                        String sql3 = "Select books.bookserial,bookname,admnumber,dateissued,booktitle from issuedbooks,books where books.bookserial=issuedbooks.bookserial and books.status='" + "ISSUED" + "' and issuedbooks.status='" + "LOST" + "'  order by bookname";
                        ps = con.prepareStatement(sql3);
                        rs = ps.executeQuery();
                ...
                try {
                    if (classfilter.getSelectedIndex() == 0) {
                        infor.setText("LOST BOOKS(Limited View)");
                        ...
                        infor.setText(classfilter.getSelectedItem() + " LOST BOOKS (Limited View)");
                        int counter = 1;
                        String sql3 = "Select books.bookserial,bookname,subjectcode,classcode,admnumber,dateissued,booktitle from issuedbooks,books where books.bookserial=issuedbooks.bookserial and books.status='" + "ISSUED" + "'  and issuedbooks.status='" + "LOST" + "' order by bookname";
                        ps = con.prepareStatement(sql3);
                        rs = ps.executeQuery();
            ...
            try {
                if (Globals.Level.equalsIgnoreCase("Admin")) {
                    if (booktypefilter.getSelectedIndex() == 0) {
                        ...
                        try {
                            if (subjectfilter.getSelectedIndex() > 0 && classfilter.getSelectedIndex() == 0) {
                                infor.setText(subjectfilter.getSelectedItem() + "   " + booktypefilter.getSelectedItem().toString().toUpperCase() + "  LOST");
                                int counter = 1;
                                String sql3 = "Select books.bookserial,bookname,admnumber,dateissued,booktitle from issuedbooks,books where books.bookserial=issuedbooks.bookserial and books.status='" + "ISSUED" + "' and issuedbooks.status='" + "LOST" + "' order by bookname";
                                ps = con.prepareStatement(sql3);
                                rs = ps.executeQuery();
                                ...
                                infor.setText(classfilter.getSelectedItem() + "  " + subjectfilter.getSelectedItem() + "  " + booktypefilter.getSelectedItem() + "S LOST");
                                int counter = 1;
                                String sql3 = "Select books.bookserial,bookname,admnumber,dateissued,booktitle from issuedbooks,books where books.bookserial=issuedbooks.bookserial and books.status='" + "ISSUED" + "' and issuedbooks.status='" + "LOST" + "'  order by bookname";
                                ps = con.prepareStatement(sql3);
                                rs = ps.executeQuery();
                                ...
                                infor.setText(booktypefilter.getSelectedItem().toString().toUpperCase() + "S LOST");
                                ...
                                infor.setText(classfilter.getSelectedItem() + "   " + booktypefilter.getSelectedItem().toString().toUpperCase() + "  LOST");
                                int counter = 1;
                                String sql3 = "Select books.bookserial,bookname,admnumber,dateissued,booktitle from issuedbooks,books where books.bookserial=issuedbooks.bookserial and books.status='" + "ISSUED" + "' and issuedbooks.status='" + "LOST" + "' order by bookname";
                                ps = con.prepareStatement(sql3);
                                rs = ps.executeQuery();
                    ...
                    if (booktypefilter.getSelectedIndex() == 0) {
                        ...
                        if (subjectfilter.getSelectedIndex() > 0 && classfilter.getSelectedIndex() == 0) {
                            ...
                            try {
                                if (classfilter.getSelectedIndex() == 0) {
                                    ...
                                    infor.setText(classfilter.getSelectedItem() + " BOOKS LOST(Limited View)");
                                    int counter = 1;
                                    String sql3 = "Select books.bookserial,bookname,subjectcode,classcode,admnumber,dateissued,booktitle from issuedbooks,books where books.bookserial=issuedbooks.bookserial and books.status='" + "ISSUED" + "'  and issuedbooks.status='" + "LOST" + "' order by bookname";
                                    ps = con.prepareStatement(sql3);
                                    rs = ps.executeQuery();
                        ...
                        if (subjectfilter.getSelectedIndex() > 0 && classfilter.getSelectedIndex() == 0) {
                            ...
                            try {
                                infor.setText(subjectfilter.getSelectedItem() + " " + booktypefilter.getSelectedItem().toString().toUpperCase() + " LOST(Limited View)");
                                int counter = 1;
                                String sql3 = "Select books.bookserial,bookname,subjectcode,classcode,admnumber,dateissued,booktitle from issuedbooks,books where books.bookserial=issuedbooks.bookserial and books.status='" + "ISSUED" + "'  and issuedbooks.status='" + "LOST" + "'  order by bookname";
                                ps = con.prepareStatement(sql3);
                                rs = ps.executeQuery();
                            ...
                            infor.setText(classfilter.getSelectedItem() + "  " + subjectfilter.getSelectedItem() + booktypefilter.getSelectedItem().toString().toUpperCase() + " LOST(Limited View)");
                            try {
                                int counter = 1;
                                String sql3 = "Select books.bookserial,type,bookname,subjectcode,classcode,admnumber,dateissued,booktitle from issuedbooks,books where books.bookserial=issuedbooks.bookserial and books.status='" + "ISSUED" + "' and type='" + booktypefilter.getSelectedItem() + "'   and issuedbooks.status='" + "LOST" + "' order by bookname";
                                ps = con.prepareStatement(sql3);
                                rs = ps.executeQuery();
                                while (rs.next()) {
