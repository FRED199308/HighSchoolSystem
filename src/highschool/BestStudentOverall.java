 ...
 * @author FRED
 */
public class BestStudentOverall extends JFrame implements ActionListener {
    ...
    public BestStudentOverall() {

        setSize(width, height);
        setTitle("Best Student Overall");
                    ...
                    if (jacademicyear.getSelectedIndex() == 0) {
                        ...
                        if (jexamcode.getSelectedIndex() == 0) {
                            ...
                            if (jexame.getSelectedIndex() == 0) {
                                ...
                                BestStudentOverallReport.beststudents(jexamcode.getSelectedItem().toString(), jexame.getSelectedItem().toString(), jterm.getSelectedItem().toString(), jacademicyear.getSelectedItem().toString(), jclass.getSelectedItem().toString(), st, Integer.parseInt(jnumber.getText()));
