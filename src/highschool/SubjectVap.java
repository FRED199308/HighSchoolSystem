 ...
 * @author FRED
 */
public class SubjectVap extends JFrame implements ActionListener {
    ...
    public SubjectVap() {
        ...
        setTitle("Value Addition Progress Per Subject");
        ...
        add(jsubjectcode);
        // number.setBounds(500,250,200,30);add(number);
        //  jnumber.setBounds(600,250,100,30);add(jnumber);

        cancel.setBounds(100, 320, 130, 50);
        add(cancel);

        view.setBounds(400, 320, 200, 50);
        add(view);
                        ...
                        if (jexamcode.getSelectedIndex() == 0) {
                            ...
                            if (jexame.getSelectedIndex() == 0) {
                                ...
                                if (jsubject.getSelectedIndex() == 0) {
                                    JOptionPane.showMessageDialog(this, "Select The Subject To View Its value Addition Progress");
                                } else {
                                    ...
                                    new Thread() {
                                        ...
                                        public void run() {
                                            ...
                                            ReportGenerator.subjectVap(jexamcode.getSelectedItem().toString(), jexame.getSelectedItem().toString(), jterm.getSelectedItem().toString(), jacademicyear.getSelectedItem().toString(), jclass.getSelectedItem().toString(), st, jsubjectcode.getSelectedItem().toString());
