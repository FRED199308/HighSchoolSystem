 ...
 * @author FRED
 */
public class ClassListGenerator extends JFrame implements ActionListener {

    public static void main(String[] args) {
        new ClassListGenerator();
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (obj == cancel) {
            ...
            if (jclassname.getSelectedIndex() == 0 && jstream.getSelectedIndex() == 0) {
                ...
                ClassListReport.generalClassList(st, jclassname.getSelectedItem().toString(), gen);
            }
