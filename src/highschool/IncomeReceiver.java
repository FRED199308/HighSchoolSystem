 ...
 * @author FREDDY
 */
public class IncomeReceiver extends JFrame implements ActionListener {
    ...
    public IncomeReceiver() {

        setTitle("Recieve Income From External Source");
            ...
            if (jacc.getSelectedIndex() == 0) {
                ...
                if (jvotehead.getSelectedIndex() == 0) {
                    ...
                    if (jamount.getText().isEmpty()) {
                        ...
                        String desc = JOptionPane.showInputDialog("Input The Particulars");
                        if (desc == null || desc.isEmpty()) {
                            JOptionPane.showMessageDialog(this, "Input Short Description On Income Source");
                        } else {
                            String accountid = Globals.AccountCode(jacc.getSelectedItem().toString());
                            String voteHeadId = Globals.voteHeadId(jvotehead.getSelectedItem().toString());
                            ...
                            try {
                                ...
                                ps = con.prepareStatement("Insert into accountReceivables values('" + accountid + "','" + voteHeadId + "','" + Globals.currentTermName() + "','" + Globals.academicYear() + "','" + donationid + "',curDate(),'" + donationAmount + "')");
                                ps.execute();

                                String itemname = desc + "  " + ", " + jvotehead.getSelectedItem();
