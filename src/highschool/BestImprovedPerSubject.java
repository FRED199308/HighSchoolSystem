 ...
 * @author ExamSeverPc
 */
public class BestImprovedPerSubject extends JFrame implements ActionListener {
    ...
    private FredButton subjectImprovement = new FredButton("Improved Per Subject");
    ...
    public BestImprovedPerSubject() {


        setSize(width, height);
        setTitle("Most Improved Student");
        ...
        subject.setBounds(30, 370, 120, 30);
        add(subject);
        jsubject.setBounds(100, 370, 200, 30);
        add(jsubject);
        jsubjectcode.setBounds(330, 370, 150, 30);
        add(jsubjectcode);
        number.setBounds(500, 370, 200, 30);
        add(number);
        jnumber.setBounds(600, 370, 100, 30);
        add(jnumber);
        analyse.setBounds(500, 340, 200, 30);
        add(analyse);

        cancel.setBounds(80, 420, 130, 50);
        add(cancel);


        subjectImprovement.setBounds(480, 420, 200, 50);
        add(subjectImprovement);
        bar.setBorder(new TitledBorder("Processing Request Please Wait...,it May Take several Minutes.."));
        bar.setBounds(150, 470, 400, 25);
        add(bar);
        ...
        subjectImprovement.addActionListener(this);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (obj == cancel) {
            ...
            jexamcode1.addActionListener(this);
        } else if (obj == subjectImprovement) {
                                        ...
                                        if (jacademicyear.getSelectedIndex() == 0) {
                                            ...
                                            if (jexamcode.getSelectedIndex() == 0) {
                                                ...
                                                if (jexame.getSelectedIndex() == 0) {
                                                    ...
                                                    String SubjectCode1 = jsubjectcode.getSelectedItem().toString();
                                                    ...
                                                    if (analyse.isSelected()) {
                                                        new Thread() {
                                                            public void run() {
                                                                ...
                                                                BestStudentOverallReport.improvedStudentsReportPerSubject(examCode, examName, academicYear, class1, term, examCode1, examName1, academicYear1, class11, term1, jclass1.getSelectedItem().toString(), SubjectCode1, limit);
                                                                bar.setVisible(false);
                                                            }
